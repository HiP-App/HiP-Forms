...
{
    public interface IFullDataFetcher {
        ...
        /// <returns></returns>
        Task FetchFullDataIntoDatabase (String downloadableId, int idForRestApi, CancellationToken token, IProgressListener listener);

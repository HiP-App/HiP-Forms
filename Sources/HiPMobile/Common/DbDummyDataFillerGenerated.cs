...
UpdateProgress(71, 231);
var _159 = CreateAudio (
    "159.mp3", 
    "Eine Fotografie aus der Zeit um 1900 zeigt Ihnen auf Ihrem Display den ursprünglichen Standort. Aus Platzgründen wurde das Rotho-Grabmal im Laufe des 20. Jahrhunderts mehrfach versetzt: 1924 zunächst in das Atrium und 1959 an seinen heutigen Standort im sogenannten Hasenkamp. Damit hat sich auch die sakraltopographische Situation verändert: So richtete Rotho seine Gebete ursprünglich nach Osten, d.h. in Richtung der erwarteten Wiederkehr Christi.", 
    ""
  );
UpdateProgress(72, 231);
...
UpdateProgress(119, 231);
var noImage = CreateImage (
    "No Image", 
    "Hier fehlt das Bild", 
    "noImage.jpg"
  );
UpdateProgress(120, 231);
...
UpdateProgress(137, 231);
Kaisermachtschule.Pages.Add( CreateAppetizerPage ("Was hat Karl der Große mit Schule, Schrift und Bildung zu tun?", theoTeaser) );
UpdateProgress(138, 231);
Kaisermachtschule.Pages.Add( CreateImagePage (noImage, null, null, _166) );
UpdateProgress(139, 231);
Kaisermachtschule.Pages.Add( CreateImagePage (noImage, null, null, _172) );
UpdateProgress(140, 231);
Kaisermachtschule.Pages.Add( CreateImagePage (noImage, null, null, _178) );
UpdateProgress(141, 231);
Kaisermachtschule.Pages.Add( CreateImagePage (noImage, null, null, _185) );
UpdateProgress(142, 231);
Kaisermachtschule.Pages.Add( CreateImagePage (noImage, null, null, _195) );
UpdateProgress(143, 231);
...
UpdateProgress(148, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_3_1, null, null, sprechertext_3_1) );
UpdateProgress(149, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_3_2, null, null, sprechertext_3_2) );
UpdateProgress(150, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_4, null, null, sprechertext_4) );
UpdateProgress(151, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_5_1, null, null, sprechertext_5_1) );
UpdateProgress(152, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_5_2, null, null, sprechertext_5_2) );
UpdateProgress(153, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_5_3, null, null, sprechertext_5_3) );
UpdateProgress(154, 231);
kaiserpfalz.Pages.Add( CreateImagePage (kaiserpfalz_image_7_1, null, null, sprechertext_7_1) );
UpdateProgress(155, 231);
...
UpdateProgress(221, 231);
TaufenAnDerPader.Pages.Add( CreateTextPage("Sagst du dem Teufel ab?\n	Und er antwortet: Ich sage dem Teufel ab.\nUnd allem Teufelsopfer?\n	Er antwortet: Und ich sage ab allem Teufelsopfer.\nUnd allen Werken des Teufels?\n	Er antwortet: Und ich schwöre ab allen Werken und Worten \n	des Teufels, Donar und Wotan und Saxnot und all den \n	Teufeln, die ihre Genossen sind.\nGlaubst du an Gott, den allmächtigen Vater?\n	Ich glaube an Gott, den allmächtigen Vater.\nGlaubst du an Christus, den Sohn Gottes?\n	Ich glaube an Christus, den Sohn Gottes.\nGlaubst du an den Heiligen Geist?\n	Ich glaube an den Heiligen Geist.", "Hochdeutschen Übersetzung des Altsächsischen Taufgelöbnisses", "Übersetzung zitiert nach: Walter Haug / Benedikt Konrad Vollmann (Hg.): Frühe deutsche Literatur und lateinische Literatur in Deutschland 800-1150 (Bibliothek des Mittelalters 1) (Bibliothek deutscher Klassiker 62), Frankfurt a.M. 1991, S. 19.", null, _011) );
UpdateProgress(222, 231);

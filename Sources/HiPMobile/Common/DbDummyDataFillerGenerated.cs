...
UpdateProgress(3, 237);
var sprechertext_3_1 = CreateAudio (
    "sprechertext_3_1.mp3", 
...
UpdateProgress(4, 237);
var sprechertext_3_2 = CreateAudio (
    "sprechertext_3_2.mp3", 
...
UpdateProgress(5, 237);
var sprechertext_4 = CreateAudio (
    "sprechertext_4.mp3", 
...
UpdateProgress(6, 237);
var sprechertext_5_1 = CreateAudio (
    "sprechertext_5_1.mp3", 
...
UpdateProgress(7, 237);
var sprechertext_5_2 = CreateAudio (
    "sprechertext_5_2.mp3", 
...
UpdateProgress(8, 237);
var sprechertext_5_3 = CreateAudio (
    "sprechertext_5_3.mp3", 
...
UpdateProgress(9, 237);
var sprechertext_7_1 = CreateAudio (
    "sprechertext_7_1.mp3", 
...
UpdateProgress(10, 237);
var sprechertext_7_2 = CreateAudio (
    "sprechertext_7_2.mp3", 
    "Einen Eindruck der Größenverhältnisse vermittelt Ihnen der Slider.", 
    ""
  );
UpdateProgress(11, 237);
var sprechertext_8 = CreateAudio (
    "sprechertext_8.mp3", 
...
UpdateProgress(12, 237);
var _003 = CreateAudio (
    "003.mp3", 
    "Herzlich willkommen zu unserem Stadtrundgang zu Karl dem Großen!\nWas hat der bedeutende Frankenkönig und spätere Kaiser mit Paderborn in Ostwestfalen zu tun? Sein Name und sein Wirken sind in der Stadt noch sehr präsent: Karlschule, Karlstraße, Kaiserpfalz.\n777 waren alle Augen auf Paderborn gerichtet: Damals fand hier zum ersten Mal eine Reichsversammlung außerhalb des fränkischen Stammlandes statt. Und Paderborn blieb bedeutsam, denn ein Jahr vor Karls Kaiserkrönung in Rom suchte Papst Leo III. Zuflucht und Schutz und fand sie in Paderborn.\nDies und anderes Wissenswertes erfahren Sie auf unserem zweistündigen Stadtrundgang. Wer waren die historischen Personen? Welche Spuren haben sie hinterlassen? Welche Beziehung hatten und haben die Menschen hier zu Karl dem Großen?", 
    ""
  );
UpdateProgress(13, 237);
...
UpdateProgress(20, 237);
var _011 = CreateAudio (
    "011.mp3", 
    "Forsachistu diabolae?\n	et respondet: ec forsacho diabolae.\nend allum diobolgeldę?\n	respondet: end ec forsacho allum diobolgeldae.\nend allu dioboles wercum?\n	respondet: end ec forsacho allum dioboles wercum and\n	wordum, Thunaer ende Woden ende Saxnote ende\n	allm them unholdum, the hira genotas sint.\ngelobistu in got alamehtigan fadaer?\n	ec gelobo in got alamehtigan fadaer.\ngelobistu in Crist, godes suno?\n	ec gelobo in Crist, gotes suno.\ngelobistu in halogan gast?\n	ec gelobo in halogan gast.\n\n(zitiert nach: Walter Haug / Benedikt Konrad Vollmann (Hg.): Frühe deutsche Literatur und lateinische Literatur in Deutschland 800-1150 (Bibliothek des Mittelalters 1) (Bibliothek deutscher Klassiker 62), Frankfurt a.M. 1991, S. 18.)", 
    ""
  );
UpdateProgress(21, 237);
...
UpdateProgress(22, 237);
var _013 = CreateAudio (
    "013.mp3", 
    "Das Altsächsische bezeichnet die frühmittelalterlichen Dialekte der Sachsen bis 1050. Verschriftlicht wird es im deutschen Sprachgebiet nur selten im Nachklang der sogenannten karolingischen Bildungsreform<fn>Dieter Kartschoke: Artikel Altsächsische Literatur, in: Reallexikon der deutschen Literaturwissenschaft. Neubearbeitung des Reallexikons der deutschen Literaturgeschichte, gemeinsam mit Harald Fricke, Klaus Grubmüller und Jan-Dirk Müller hg. von Klaus Weimar, Berlin / New York 2007, Bd. 1, S. 65-67, hier: S. 66.</fn>.  Auch in Paderborn sprach man Altsächsisch. Das können Sie auf der eingeblendeten Karte sehen.\nDie wichtigsten literarischen Werke in altsächsischer Sprache sind der fast vollständig überlieferte Heliand, die altsächsische Genesis und – als ältester überlieferter Text – das Altsächsische Taufgelöbnis <fn>Dieter Kartschoke: Artikel Altsächsische Literatur, in: Reallexikon der deutschen Literaturwissenschaft. Neubearbeitung des Reallexikons der deutschen Literaturgeschichte, gemeinsam mit Harald Fricke, Klaus Grubmüller und Jan-Dirk Müller hg. von Klaus Weimar, Berlin / New York 2007, Bd. 1, S. 65-67, hier: S. 66.</fn>. ", 
    ""
  );
UpdateProgress(23, 237);
var _014 = CreateAudio (
    "014.mp3", 
    "Was ist eigentlich der Unterschied zwischen dem Altsächsischen und Neuhochdeutschen? \n Altsächsisch ist der Vorläufer des Mittelniederdeutschen – und damit auch des Plattdeutschen. Es grenzt sich vom Althochdeutschen, dem Vorläufer des Mittel- und Neuhochdeutschen, vor allem durch die nicht durchgeführte zweite Lautverschiebung ab. So sind - im Gegensatz zum Althochdeutschen - die stimmlosen Verschlusslaute p, t, k nicht zu Reibelauten und Affrikaten verschoben (z.B. altsächsisch opan / althochdeutsch offan / neuhochdeutsch „offen“) <fn>Claudine Moulin: Altsächsisch, in: Helmut Glück (Hg.): Metzler Lexikon Sprache, 4., überarbeitete Auflage, Stuttgart 2010, S. 35; Stefanie Stricker: Lautverschiebung, in: Helmut Glück (Hg.): Metzler Lexikon Sprache, 4., überarbeitete Auflage, Stuttgart 2010, S. 390.</fn>.  Heute steht im christlichen Glaubensbekenntnis „Dein Reich komme“. Im Althochdeutschen queme thīn rīhhi und im Altsächsischen cuma thîn craftag rîki.", 
    ""
  );
UpdateProgress(24, 237);
...
UpdateProgress(32, 237);
var _021 = CreateAudio (
    "021.mp3", 
    "Auslöser der Sachsenkriege waren zu Beginn der 770er Jahre zunächst kleinere Grenzkonflikte und wechselseitige Raubzüge gewesen. Sie hatten den Frankenkönig nach mehreren erfolglosen Strafexpeditionen schließlich dazu bewogen, die direkte Konfrontation mit den Sachsen zu suchen. Ein Paukenschlag war im Jahre 772 die Zerstörung der sächsischen Eresburg und der Irminsul. Die Irminsul war ein sächsisches Heiligtum, vermutlich eine große hölzerne Säule oder ein Baumstamm oder –stumpf in der Nähe des heutigen Obermarsberg<fn>Ernst Karpf: Artikel Irminsul, in: Lexikon des Mittelalters, Bd. 5, Stuttgart / Weimar 1999, Sp. 663; Matthias Springer: Die Sachsen, Stuttgart 2004, S. 162-165.</fn>.  Die Sachsen waren damals Heiden und verehrten dort Götter wie Thor, Wotan und Saxnot. Karl, der nach dem überraschenden Tod seines Bruders Karlmann Ende 771 zum Alleinherrscher im Frankenreich aufgestiegen war, erbeutete dort Gold und Silber und konnte so seine Gefolgsleute belohnen.<fn>Annales regni Francorum ad a. 772, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 32 und S. 34: Et inde perrexit partibus Saxoniae prima vice, Eresburgum castrum coepit, ad Ermensul usque pervenit et ipsum fanum destruxit et aurum vel argentum, quod ibi repperit, abstulit.</fn> Mit seiner Militärexpedition gegen das unbotmäßige Grenzvolk zeigte er sich aber auch als starker und machtvoller Herrscher. Doch dann ließ Karl der Große das Thema Sachsen zunächst auf sich beruhen. Weitere Maßnahmen plante er damals nicht. Auch von einer zielgerichteten Missionierung und Christianisierung der heidnischen Sachsen war zu diesem Zeitpunkt noch keine Rede.", 
    ""
  );
UpdateProgress(33, 237);
var _022 = CreateAudio (
    "022.mp3", 
    "Die Sachsen rächten sich bald darauf für die Zerstörung ihres Heiligtums. Sie überfielen fränkisches Gebiet, griffen dort Häuser und Kirchen an und versuchten sie niederzubrennen.<fn>Annales regni Francorum ad a. 773, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 36 und S. 38.</fn> Karl war unterdessen in Italien in einen Krieg mit den Langobarden verwickelt. Nachdem er diese besiegt hatte, griff er die Sachsen 776 erneut mit einem groß angelegten Feldzug an und verfolgte sie bis zur Lippe.<fn>Annales regni Francorum ad a. 776, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 46: Et inde fugam arripientes Saxones, persecute sunt eos Franci interficientes illos usque ad flumen Lippiam, castro salvato; et cum victoria reverse sunt Franci.</fn> Was mit kleineren militärischen Strafexpeditionen als Geplänkel an der Grenze begonnen hatte, das wurde nun zu einem offenen Krieg. Und hier beginnt die zweite Eskalationsstufe der Sachsenkriege, die mit der Taufe des Sachsenführers Widukind 785 in Attigny endete. Seine angebliche, historisch aber nicht gesicherte Taufschale haben Sie ja bereits kennengelernt.", 
    ""
  );
UpdateProgress(34, 237);
...
UpdateProgress(36, 237);
var _024 = CreateAudio (
    "024.mp3", 
    "Einhards drastische Schilderung der wortbrüchigen Saxones verkennt jedoch, dass die Sachsen politisch völlig anders strukturiert waren als die Franken: Sie waren gerade nicht – wie Einhard uns suggerieren möchte – eine ‚staatliche Einheit‘ mit einem König an ihrer Spitze, einer zentralen Hauptstadt und zahlreichen gemeinsamen Institutionen. Auf Ihrem Display sehen Sie nun eine Karte, die die räumliche Gliederung Sachsens zeigt.", 
    ""
  );
UpdateProgress(37, 237);
var _025 = CreateAudio (
    "025.mp3", 
    "Sie sehen, dass die Sachsen mit den Westfalen, den Engern und den Ostfalen aus drei großen Obergruppen bestanden. Diese wurden von verschiedenen Kleinkönigen beherrscht und unterstellten sich lediglich im Kriegsfall ‚Satrapen‘ genannten Anführern.<fn>Siehe dazu Matthias Becher: Die Sachsen im 7. und 8. Jahrhundert. Verfassung und Ethnogenese, in: 799. Kunst und Kultur der Karolingerzeit. Karl der Große und Papst Leo III. in Paderborn. Katalog der gemeinsamen Ausstellung der Stadt Paderborn, des Erzbistums Paderborn und des Landesverbandes Westfalen-Lippe vom 23. Juli bis 1. November 1999, 3 Bde., hg. von Christoph Stiegemann / Matthias Wemhoff, Mainz 1999, Bd. 1, S. 188-194; Matthias Springer: Die Sachsen, Stuttgart 2004, S. 131-152.</fn> Die Sachsen selbst haben keine Schriftzeugnisse hinterlassen, die uns über ihre politischen Strukturen und ihre Verfassung unterrichten könnten. Deshalb sind wir auf die ‚Außensicht‘ der fränkischen Geschichtswerke angewiesen. Diese subsumieren die verschiedenen Gruppen zumeist pauschal unter dem Oberbegriff ‚Sachsen‘. Das erklärt auch, warum zum Beispiel Einhard so oft von gebrochenen Eiden und Verträgen und immer neuen Aufständen der Sachsen berichtet. Für ihn waren das die Taten ‚der Sachsen‘. Tatsächlich aber waren es wohl verschiedene Aktionen einzelner sächsischer Gruppen und Untergruppen. Hinzu kam, dass für den Christen Einhard, der im Kloster Fulda ausgebildet und erzogen worden war, die heidnischen Sachsen gleichsam prädestiniert waren für Treuelosigkeit und Hinterlist, für Eid- und Vertragsbruch.", 
    ""
  );
UpdateProgress(38, 237);
var _026 = CreateAudio (
    "026.mp3", 
    "Ab 775 änderte sich freilich auch die Strategie Karls des Großen. Die um 890 in Paderborn verfasste Translatio sancti Liborii, die Sie ja schon kennengelernt haben, nennt Karl einen „Apostel“ der Sachsen, der ihnen „doch sozusagen mit eiserner Zunge gepredigt“ habe.<fn>Translatio sancti Liborii, cap. 7. Vita et translatio anonymi Paderbornensis. Edition mit Übersetzung der Translatio von: Volker de Vry: Liborius. Brückenbauer Europas. Die mittelalterlichen Viten und Translationsberichte. Mit einem Anhang der Manuscripta Liboriana, Paderborn / München / Wien / Zürich 1997, S. 177-222, hier: S. 194: Quem arbitror nostrum iure apostolum nominari, quibus, ut ianuam fidei aperiret, ferrea quodammodo lingua praedicauit; deutsche Übersetzung nach: Volker de Vry: Liborius. Brückenbauer Europas. Die mittelalterlichen Viten und Translationsberichte. Mit einem Anhang der Manuscripta Liboriana, Paderborn / München / Wien / Zürich 1997, S. 177-222, hier: S. 194: „Ich glaube, daß er mit Recht unser Apostel genannt wird, hat er uns doch sozusagen mit eiserner Zunge gepredigt, um uns die Pforte des Glaubens zu öffnen.“</fn> Auf einer Reichsversammlung in Quierzy beriet sich der König damals mit seinen vornehmsten Adligen. Er beschloss, „das treulose und wortbrüchige Volk der Sachsen mit Krieg zu überziehen, bis sie entweder besiegt und zum Christentum bekehrt oder ganz ausgerottet waren“.<fn>Annales qui dicuntur Einhardi ad a. 775, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 41: Cum rex in villa Carisiaco hiemaret, consilium iniit, ut perfidam ac foedifragam Saxonum gentem bello adgrederetur et eo usque perseveraret, dum aut victi christianae religioni subicerentur aut omnino tollerentur; deutsche Übersetzung nach: Matthias Becher: Der Prediger mit eiserner Zunge. Die Unterwerfung und Christianisierung der Sachsen durch Karl den Großen, in: Hermann Kamp / Martin Kroker (Hg.): Schwertmission. Gewalt und Christianisierung im Mittelalter, Paderborn 2013, S. 23–52, hier: S. 32.</fn> Sicherlich stellt der deutlich später – nämlich um 814/17 – schreibende Autor die Ereignisse und vor allem die Alternative ‚Tod oder Taufe‘ reichlich überspitzt dar. Auffällig ist allerdings, dass auch ein namenloser Zeitgenosse berichtet, Karl sei 775 gegen die Sachsen vorgerückt und habe dort sehr viele getauft und noch mehr getötet.<fn>Annales Sangallenses Baluzii ad a. 775, ed. von Georg Heinrich Pertz (MGH SS 1), Hannover 1826, S. 63: in ipso anno perrexit Karlus super Saxones, et plurimos ex ipsis ad baptismi gratiam perduxit, et multos pluriores interfecit.</fn> Und sogar ein weit entfernter Beobachter aus Northumbrien, dem heutigen Nordengland, wunderte sich und schrieb, König Karl habe in Sachsen gewütet, als hätte er den Verstand verloren.<fn>Annales Northumbrani: Ex vetustis Annalibus Northumbranis. Historiae regum Anglorum et Dacorum insertis, ed. von Georg Waitz (MGH SS 13), Hannover 1881, S. 155: Karl denique rex, ut praefati sumus, bellicosissimus Francorum cum omni exercitus sui virtute vallatus, confortatus glorificatus gentem Saxonum est ingressus, centuriatibus et legionibus stipatus, quam magis et inedicibilibus regionem praeliis gravissimis vastavit. Igne ferroque debacchans, quia erat consternatus animo. Deutsche Übersetzung: „Schließlich verschanzte sich König Karl, wie wir oben bereits erwähnt haben, der kriegerischste der Franken, umgeben von der ganzen Tapferkeit seines Heeres; der übermächtige und gepriesene [König Karl] ist gegen das Volk der Sachsen marschiert, dicht umringt von Zenturien und Legionen; er hat das Gebiet mit unbeschreiblichen und allerschwersten Gefechten verwüstet. Mit Feuer und Eisen raste er, weil er im Geiste verwirrt war.“</fn>", 
    ""
  );
UpdateProgress(39, 237);
var _027 = CreateAudio (
    "027.mp3", 
    "Und tatsächlich sind für das Jahr 776 auch erstmals sächsische Massentaufen bei der Lippequelle in der Nähe von Paderborn belegt. Die Reichsannalen, ein offiziöses Geschichtswerk, das fast zeitgleich mit den Ereignissen am Königshof verfasst wurde, berichten uns dazu folgendes:\n „Und die Sachsen kamen erschreckt alle von allen Seiten am Lippeursprung zusammen und übergaben unter Stellung von Bürgen alle ihr Land [patria] ihnen [den Franken] zu Händen und versprachen Christen zu werden und stellten sich unter die Herrschaft [dicio] des Königs Karl und der Franken. (…) und dorthin kamen die Sachsen mit Frau und Kind in endloser Zahl und ließen sich taufen und stellten Geiseln (…).“<fn>Annales regni Francorum ad a. 776, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 46: Et Saxones perterriti omnes ad locum, ubi Lippia consurgit, venientes ex omni parte et reddiderunt patriam per wadium omnes manibus eorum et spoponderunt se esse christianos et sub dicione domni Caroli regis et Francorum subdiderunt. (…) ibique venientes Saxones una cum uxoribus et infantibus innumerabilis multitudo baptizati sunt et obsides (…) dederunt; deutsche Übersetzung nach: Quellen zur karolingischen Reichsgeschichte, 1. Teil neubearbeitet von Reinhold Rau (Ausgewählte Quellen zur deutschen Geschichte des Mittelalters. Freiherr vom Stein-Gedächtnisausgabe 5), Darmstadt 1955, S. 35.</fn>", 
    ""
  );
UpdateProgress(40, 237);
var _028 = CreateAudio (
    "028.mp3", 
    "Karl der Große schien sein Ziel erreicht zu haben: Die Sachsen ließen sich taufen und hatten sich seiner Herrschaft unterworfen. Dies bekräftigten sie sogar mit einem Eid. In Karls Politik waren politische Unterwerfung und Christianisierung der Sachsen jetzt erstmals miteinander verknüpft. Bis dahin hatte die Christianisierung in Karls Sachsenpolitik keine so große Rolle gespielt. Mit dieser Wende ging 775 die erste Phase der Sachsenkriege zu Ende, aber ein Ende des Krieges war noch nicht absehbar.\nIm Jahre 777 richteten sich alle Augen der fränkischen Welt auf unsere Stadt. Denn erstmals hielt ein fränkischer König eine große Reichsversammlung außerhalb des fränkischen Kernlandes ab, und dies ausgerechnet im sächsischen Paderborn. Auf Reichsversammlungen besprach der König mit den Adligen wichtige politische und militärische Entscheidungen. Auch wurden Gesetze erlassen, Gerichtsentscheidungen gefällt, Streitigkeiten geschlichtet und Urkunden ausgestellt. In Paderborn nahmen neben den Franken auch viele Sachsen teil. Sogar arabische Gesandte aus dem fernen Spanien fanden den Weg nach Paderborn, um den Frankenkönig um Hilfe gegen den mächtigen Emir von Córdoba zu bitten.<fn>Annales regni Francorum ad a. 777, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 48: Etiam Hispaniae, hi sunt Ibin al Arabi et filius Deiuzefi, qui et latine Ioseph nominatur, similiter et gener eius.</fn> Fern blieb lediglich Widukind, der sich stattdessen in Dänemark aufhielt.<fn>Annales regni Francorum ad a. 777, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 48: Tunc domus Carolus rex synodum publicum habuit ad Paderbrunnen prima vice. Ibique convenientes omnes Franci, et ex omni parte Saxoniae undique Saxones convenerunt, excepto quod Widochindis rebellis extitit cum paucis aliis: in partibus Nordmanniae confugium fecit una cum sociis suis.</fn> Doch was genau wurde in Paderborn besprochen? Im Mittelpunkt stand sicher die Einteilung Sachsens in Missionsbezirke, die Vorläufer der späteren Bistümer, wobei Paderborn zunächst dem Bistum Würzburg zugeordnet wurde.<fn>Peter Johanek: Der Ausbau der sächsischen Kirchenorganisation, in: 799. Kunst und Kultur der Karolingerzeit. Karl der Große und Papst Leo III. in Paderborn. Katalog der gemeinsamen Ausstellung der Stadt Paderborn, des Erzbistums Paderborn und des Landesverbandes Westfalen-Lippe vom 23. Juli bis 1. November 1999, 3 Bde., hg. von Christoph Stiegemann / Matthias Wemhoff, Mainz 1999, Bd. 2, S. 494-506.</fn>", 
    ""
  );
UpdateProgress(41, 237);
var _029 = CreateAudio (
    "029.mp3", 
    "Karl muss damals bereits von einem endgültigen Sieg über die Sachsen ausgegangen sein. In Paderborn hatte er zu dieser Zeit schon eine Pfalzanlage mit einer Salvatorkirche<fn>Annales Sangallenses Baluzii ad a. 777, ed. von Georg Heinrich Pertz (MGH SS 1), Hannover 1826, S. 63: hoc anno fuit domnus rex Karlus in Saxonia ad Patrisbrunna, et ibi aedificavit ecclesiam in honore Salvatoris.</fn> errichten lassen und sie zu einem fränkischen Stützpunkt in Sachsen ausgebaut. Sie wird in einem zeitgenössischen Geschichtswerk „Karlesburg“ genannt.<fn>Annales Mosellani ad a. 776, ed. von Johann M. Lappenberg (MGH SS 16), Hannover 1859, S. 496: Et aedificavit civitatem super fluvio Lippiae, que apellatur Karlesburg.</fn> Andere sprechen von „urbs Karoli“.<fn>Annales Petaviani ad a. 776, ed. von Georg Heinrich Pertz (MGH SS 1), Hannover 1826, S. 16: (...) aedificaverunt Franci in finibus Saxanorum civitatem quae vocatur Urbs Karoli. Annales Maximiniani ad a. 776, ed. von Georg Waitz (MGH SS 13), Hannover 1881, S. 21: Eodem anno multa turba de Saxonibus baptizata est. Franci civitatem fecerunt in Saxonia quae dicitur urbs Caroli et Francorum.</fn> Der Name war Programm! Schließlich stellte sich Karl der Große mit dieser Benennung in eine Reihe mit so bedeutenden Herrschern wie z.B. Kaiser Konstantin dem Großen mit Konstantinopel (Constantinopolis), dem heutigen Istanbul.", 
    ""
  );
UpdateProgress(42, 237);
var _030 = CreateAudio (
    "030.mp3", 
    "Doch was ist eigentlich eine Pfalz? Der Begriff Pfalz leitet sich vom lateinischen palatium ab. Das ist der ursprüngliche Name des römischen Hügels Palatin, auf dem die römischen Kaiser seit Augustus ihre Residenz hatten.<fn>Thomas Zotz: Artikel Pfalz, Palast, A. Allgemeine Institutionsgeschichte; Frankenreich und Ostfränkisch-deutsches Reich, in: Lexikon des Mittelalters, Bd. 6, Stuttgart / Weimar 1999, Sp. 1993-1997, hier: Sp. 1993.</fn> Auch im Mittelalter gab es Pfalzen. Da es in dieser Zeit noch keine Hauptstadt im Frankenreich gab, war der König mit seinem Gefolge ständig unterwegs. Seine Herrschaft musste vor Ort sichtbar werden. Die Geschichtswissenschaft spricht deshalb auch vom ‚Reisekönigtum‘. Pfalzorte waren wichtige Stationen auf diesen Reisewegen des Königs. Hier hielt er sich häufiger auf. Deshalb durften Wohngebäude und ein nahegelegener Wirtschaftshof zur Versorgung nicht fehlen. In einem repräsentativen Saalbau wurde Politik gemacht: Hier hielt der Herrscher Reichsversammlungen ab und empfing weltliche und geistliche Würdenträger und Gesandte. Auch eine Kirche für die Feier kirchlicher Feste war vorhanden. Pfalzen waren also zugleich „Herrschaftszentren und Herrschaftszeichen“, wie der Historiker Thomas Zotz feststellt.<fn>Thomas Zotz: Artikel Pfalz, Palast, A. Allgemeine Institutionsgeschichte; Frankenreich und Ostfränkisch-deutsches Reich, in: Lexikon des Mittelalters, Bd. 6, Stuttgart / Weimar 1999, Sp. 1993-1997, hier: Sp. 1993.</fn>", 
    ""
  );
UpdateProgress(43, 237);
var _031 = CreateAudio (
    "031.mp3", 
    "Doch schon bald nach ihrer Errichtung wurde die Karlsburg zum ersten Mal von den Sachsen zerstört: Als Karl 778 zu einem Feldzug nach Spanien aufgebrochen und außer Landes war, schlugen sie zu. Sie zerstörten nicht nur die Pfalz in Paderborn,<fn>Annales Petaviani ad a. 778, ed. von Georg Heinrich Pertz (MGH SS 1), Hannover 1826, S. 16: Interim Saxones rebellantes, moveruntque exercitum amne Rene properantes, incenderuntque oppida, et igne cremaverunt civitatem, quae Franci construxerunt infra flumen Lipiam.</fn> sondern rückten auch bis an den Rhein vor und plünderten und brandschatzten dort christliche Klöster und Kirchen.<fn>Annales regni Francorum ad a. 778, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 52: (…) Saxones: sed illi rebelles ad Renum usque Diuciam pervenerunt, tunc praedantes secus Renum et multas malici</fn> Das Verhalten der Sachsen bewertete Karl als Hochverrat! Schließlich hatten sich die Sachsen doch bereits seiner Herrschaft unterworfen und ihm die Treue geschworen. Die Erfolge, die Karl bisher in Sachsen erzielt hatte, waren damit hinfällig geworden. Und auch in Spanien hatte er eine empfindliche Niederlage erlitten. Einige Jahrhunderte später wurde diese Niederlage im Rolandslied literarisch verarbeitet und umgedeutet. \nDie Situation in Sachsen eskalierte und führte zu einer schweren Krise im Frankenreich. Karl griff nun hart durch und leitete damit die zweite Phase der Sachsenkriege ein! Er besiegte 779 zunächst die Westfalen bei Bocholt, nahm Gefangene und zog dann weiter bis zur Weser, wo sich Engern und Ostfalen erneut unterwarfen und auch Geiseln stellten.<fn>Annales regni Francorum ad a. 779, ed. von Friedrich Kurze (MGH SS rer. Germ. 6), Hannover 1895 (ND 1950), S. 54: Et fuit sinodus in villa nuncupantem Duria, et iter peractus est partibus Saxoniae. Ad Lippeham transitur Renus fluvius, et Saxones voluerunt resistere in loco, qui dicitur Bohholz, auxiliante Domino non praevaluerunt, sed abinde fugientes reliquerunt omnes firmitates eorum. Et Francis aperta est via, et introeuntes in Westfalaos et conquisierunt eos omnes; reliqui, qui ultra Wisora fuerunt, cum se iunxisset domnus Carolus rex ad locum, qui dicitur Medofulli, ibi dederunt obsides et deinde sacramenta firmantes. Et tunc reversus est suprascriptus gloriosus rex in Francia.</fn> ", 
    ""
  );
UpdateProgress(44, 237);
var _032 = CreateAudio (
    "032.mp3", 
...
UpdateProgress(47, 237);
var _034 = CreateAudio (
    "034.mp3", 
    "„Der Glaube ist eine Sache der Freiwilligkeit, nicht des Zwanges (…). Wenn man das sanfte Joch Christi und seine leichte Last dem störrischen Sachsenvolk mit solcher Beharrlichkeit predigen würde, mit der man die Zehnten eintreibt und strengste Bußen für kleine Vergehen gegen das Edikt fordert, dann würden sie vielleicht das Sakrament der Taufe nicht verabscheuen. Sollen doch endlich die Lehrer des Glaubens von den Beispielen der Apostel lernen; sie sollen Prediger sein, nicht Plünderer.“<fn>Alcuini sive Albini epistolae: Briefe, Nr. 111, ed. von Ernst Dümmler (MGH Epp. 4), Berlin 1895 (ND 1994), S. 160 und S. 161, hier: S. 160: Fides quoque (…) res est voluntaria, non necessaria [nach Augustinus].Hier: S. 161: Si tanta instantia leve Christi iugum et onus suave durissimo Saxonum populo praedicaretur, quanta decimarum redditio vel legalis pro parvissimis quibuslibet culpis edicti necessitas exigebatur, forte baptismatis sacramenta non abhorrerent. Sint tandem aliquando doctores fidei apostolicis eruditi exemplis; sint praedicatores, non praedatores; deutsche Übersetzung nach: Gerd Haendler: Die Kirche im Karolingerreich (Quellen. Ausgewählte Texte aus der Geschichte der christlichen Kirche 16/II), Berlin 1962, S. 97 und S. 99.</fn>", 
    ""
  );
UpdateProgress(48, 237);
var _035 = CreateAudio (
    "035.mp3", 
...
UpdateProgress(69, 237);
var _123 = CreateAudio (
    "123.mp3", 
    "Falls Sie mehr zum Rotho-Grabmal erfahren möchten, klicken Sie auf den eingeblendeten Infobutton. ", 
    ""
  );
UpdateProgress(70, 237);
...
UpdateProgress(74, 237);
var _159 = CreateAudio (
    "159.mp3", 
    "Eine Fotografie aus der Zeit um 1900 zeigt Ihnen auf Ihrem Display den ursprünglichen Standort. Aus Platzgründen wurde das Rotho-Grabmal im Laufe des 20. Jahrhunderts mehrfach versetzt: 1924 zunächst in das Atrium und 1959 an seinen heutigen Standort im sogenannten Hasenkamp. Damit hat sich auch die sakraltopographische Situation verändert: So richtete Rotho seine Gebete ursprünglich nach Osten, d.h. in Richtung der erwarteten Wiederkehr Christi.", 
    ""
  );
UpdateProgress(75, 237);
var _166 = CreateAudio (
    "166.mp3", 
    "Auf Ihrem Display können Sie jetzt eine mittelalterliche Handschrift sehen. Es ist das sogenannte Corveyer Evangeliar aus dem Bestand der Erzbischöflichen Akademischen Bibliothek in Paderborn. Sie gehört zu den ältesten und wertvollsten Handschriften, die sich in unserer Region erhalten haben und stammt aus dem Kloster Corvey bei Höxter. Der Name klingt ungewöhnlich für ein Kloster in Ostwestfalen, oder? Das ist kein Zufall: Denn es waren Mönche aus dem französischen Corbie, die das Kloster als Nova Corbeia (also: das Neue Corbie) kurz nach dem Tod Karls des Großen 815 oder 816 gründeten. In jenem französischen Kloster Corbie entstand auch die älteste erhaltene Handschrift, in der mit karolingischer Minuskel geschrieben wurde.", 
    ""
  );
UpdateProgress(76, 237);
var _172 = CreateAudio (
    "172.mp3", 
    "Schauen Sie genau auf Ihr Display. Auch heute noch können Sie die Handschrift sehr gut lesen. Dabei ist sie vor mehr als 1000 Jahren geschrieben worden. Haben Sie schon einmal versucht, die Briefe Ihrer Urgroßeltern zu lesen? Ist es ihnen gelungen – oder eher nicht? Aber Handschriften können auch sehr gut lesbar sein. Genau darum ging es u.a. auch innerhalb der Reformbestrebungen in karolingischer Zeit. Die Präzision der karolingischen Minuskel, ihre klare Form, ist ein wichtiger Grund für die weite Verbreitung der Schrift in ganz Mittel- und Westeuropa. Über die gotische Minuskel und weitere Zwischenstufen haben sich aus ihr die heutigen Kleinbuchstaben entwickelt.", 
    ""
  );
UpdateProgress(77, 237);
var _178 = CreateAudio (
    "178.mp3", 
    "Dass Bildung ein wichtiger Faktor für die Ausübung von Macht ist, hatte bereits Karls Vater – König Pippin – erkannt. Sein Sohn aber übertraf ihn bei weitem. Aus ganz Europa versammelte Karl der Große ab dem letzten Viertel des 8. Jahrhunderts wichtige Gelehrte an seinem Hof. So kam etwa der langobardische Mönch und Geschichtsgelehrte Paulus Diaconus nach Aachen oder auch der Angelsachse Alcuin, der als größter Gelehrter seiner Zeit galt. Er wurde an der renommierten Domschule von York ausgebildet und hat dort später auch selbst unterrichtet. Ab 882 leitete er das Bildungszentrum des Reichs, die sogenannte Hofschule in Aachen. Dass die Gelehrten am Hof Karls des Großen ausschließlich Kleriker waren, ist kein Zufall – das Bildungsmonopol lag bis ins 16. Jahrhundert weitestgehend in den Händen der Kirche.", 
    ""
  );
UpdateProgress(78, 237);
var _185 = CreateAudio (
    "185.mp3", 
    "Alcuin soll es auch gewesen sein, der im Auftrag Karls des Großen die Epistula de litteris colendis,  d.h. den Brief zur Pflege der Wissenschaften, verfasst haben soll. In diesen Anweisungen ging es insbesondere um die Verbesserung der Bildung und der Wissenschaften. Was war geschehen? Seit der Spätantike hatten sich die Lateinkenntnisse auch der Kleriker zunehmend verschlechtert. Anekdoten berichten sogar davon, dass selbst Priester die Worte, die sie aus der Bibel lasen, nicht mehr richtig verstünden. Gegen diese Missstände ging Karl der Große nun vor. Denn Latein war nicht nur die heilige Sprache der Bibel, sondern damals auch die Verkehrssprache – vergleichbar dem Englischen heute. Nur wenige Jahre später wurde das Kapitular Admonitio generalis, d.h. die allgemeine Ermahnung, im ganzen Reich verbreitet. Auch hier wurde erneut auf die Bedeutung des korrekten Lateins für das Verständnis der Bibel, der Schriften der Kirchenväter und für die Bildung allgemein hingewiesen.", 
    ""
  );
UpdateProgress(79, 237);
var _195 = CreateAudio (
    "195.mp3", 
...
UpdateProgress(102, 237);
var kaiserpfalz_image_3_1 = CreateImage (
    "Befestigungsanlage", 
    "Die vermutliche Ausdehnung der Befestigungsanlage in karolingischer Zeit. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 102, Abb. 51]", 
    "kaiserpfalz_image_3_1.jpg"
  );
UpdateProgress(103, 237);
var kaiserpfalz_image_3_2 = CreateImage (
    ...
    "kaiserpfalz_image_3_2.jpg"
  );
UpdateProgress(104, 237);
var kaiserpfalz_image_4 = CreateImage (
    "Plan der Bauphasen", 
    "Plan der Bauphasen der Paderborner Kaiserpfalz. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 108]", 
    "kaiserpfalz_image_4.jpg"
  );
UpdateProgress(105, 237);
var kaiserpfalz_image_5_1 = CreateImage (
    "Rekonstruktion der Aula", 
    "Rekonstruktion der Aula , Bauphase Ib. \n[Bildnachweis: Gai / Mecke 2004, S. 120, Abb. 68]", 
    "kaiserpfalz_image_5_1.jpg"
  );
UpdateProgress(106, 237);
var kaiserpfalz_image_5_2 = CreateImage (
    "Grundriss der Salvatorkirche", 
    "Grundrisses der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 108]", 
    "kaiserpfalz_image_5_2.jpg"
  );
UpdateProgress(107, 237);
var kaiserpfalz_image_5_3 = CreateImage (
    "Rekonstruktion der Salvatorkirche", 
    "Rekonstruktion der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 122]", 
    "kaiserpfalz_image_5_3.jpg"
  );
UpdateProgress(108, 237);
var kaiserpfalz_image_7_1 = CreateImage (
    "Karolingische Pfalzanlage", 
    "Plan der karolingischen Pfalzanlage um 800. \n[Bildnachweis: Gai / Mecke 2004, Bd. I, S. 132, Abb. 77]", 
    "kaiserpfalz_image_7_1.jpg"
  );
UpdateProgress(109, 237);
var kaiserpfalz_image_last = CreateImage (
    "Museum in der Kaiserpfalz", 
    "Entdecken Sie im Museum in der Kaiserpfalz Fundstücke aus der karolingischen Pfalzanlage!", 
    "kaiserpfalz_image_1.jpg"
  );
UpdateProgress(110, 237);
var kaiserpfalz_Slider1_1 = CreateImage (
    "", 
    "Blick von Norden auf die Paderquellen vor 1945", 
    "kaiserpfalz_slider_1_1.jpg"
  );
UpdateProgress(111, 237);
var kaiserpfalz_Slider1_2 = CreateImage (
    "", 
    "Blick von Norden über die Treppe vor 1945", 
    "kaiserpfalz_slider_1_2.jpg"
  );
UpdateProgress(112, 237);
var kaiserpfalz_Slider1_3 = CreateImage (
    "", 
    "Blick von Südwesten vor 1935", 
    "kaiserpfalz_slider_1_3.jpg"
  );
UpdateProgress(113, 237);
var kaiserpfalz_Slider1_4 = CreateImage (
    "", 
    "Blick von Norden vor 1945", 
    "kaiserpfalz_slider_1_4.jpg"
  );
UpdateProgress(114, 237);
var kaiserpfalz_Slider1_5 = CreateImage (
    "", 
    "Blick von Norden um 1945", 
    "kaiserpfalz_slider_1_5.jpg"
  );
UpdateProgress(115, 237);
var kaiserpfalz_slider2_1 = CreateImage (
    "", 
    "Pfalzanlage Paderborn (Bauhhase II, 799)", 
    "kaiserpfalz_slider_7_1.jpg"
  );
UpdateProgress(116, 237);
var kaiserpfalz_slider2_2 = CreateImage (
    "", 
...
UpdateProgress(117, 237);
var kaiserpfalz_slider2_3 = CreateImage (
    "", 
...
UpdateProgress(135, 237);
var ChristianisierungDerSachsen_Page_1 = CreateAppetizerPage ("Karls neue Strategie: Tod oder Taufe?", Teaser_Christianisierung);
ChristianisierungDerSachsen.Pages.Add(ChristianisierungDerSachsen_Page_1);
UpdateProgress(136, 237);
var ChristianisierungDerSachsen_Page_2 = CreateImagePage (noImage, null, null, _026);
ChristianisierungDerSachsen.Pages.Add(ChristianisierungDerSachsen_Page_2);
UpdateProgress(137, 237);
var ChristianisierungDerSachsen_Page_3 = CreateImagePage (noImage, null, null, _027);
ChristianisierungDerSachsen.Pages.Add(ChristianisierungDerSachsen_Page_3);
UpdateProgress(138, 237);
var ChristianisierungDerSachsen_Page_4 = CreateImagePage (noImage, null, null, _028);
ChristianisierungDerSachsen.Pages.Add(ChristianisierungDerSachsen_Page_4);
UpdateProgress(139, 237);
...
UpdateProgress(140, 237);
var Kaisermachtschule_Page_1 = CreateAppetizerPage ("Was hat Karl der Große mit Schule, Schrift und Bildung zu tun?", theoTeaser);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_1);
UpdateProgress(141, 237);
var Kaisermachtschule_Page_2 = CreateImagePage (noImage, null, null, _166);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_2);
UpdateProgress(142, 237);
var Kaisermachtschule_Page_3 = CreateImagePage (noImage, null, null, _172);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_3);
UpdateProgress(143, 237);
var Kaisermachtschule_Page_4 = CreateImagePage (noImage, null, null, _178);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_4);
UpdateProgress(144, 237);
var Kaisermachtschule_Page_5 = CreateImagePage (noImage, null, null, _185);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_5);
UpdateProgress(145, 237);
var Kaisermachtschule_Page_6 = CreateImagePage (noImage, null, null, _195);
Kaisermachtschule.Pages.Add(Kaisermachtschule_Page_6);
UpdateProgress(146, 237);
...
UpdateProgress(147, 237);
var kaiserpfalz_Page_1 = CreateAppetizerPage ("Ein befestigter Stützpunkt in Sachsen – Aufbau und Entwicklung.", kaiserPfalzImage);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_1);
UpdateProgress(148, 237);
var kaiserpfalz_Page_2 = CreateImagePage (kaiserPfalzImage1, null, null, sprechertext_1);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_2);
UpdateProgress(149, 237);
var kaiserpfalz_Page_3 = CreateImagePage (kaiserpfalzImage2, null, null, sprechertext_2_1);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_3);
UpdateProgress(150, 237);
var kaiserpfalz_Page_4 = CreateTimeSliderPage("Gelände nördlich des Doms", "Fotografien des Geländes nördlich des Domes, zu Beginn des 20. Jh., in den 1930er Jahren, in den 1950er Jahren und während der Grabung. \n[Bildnachweis: Gai / Mecke 2004, S. 8, Abb. 5 und 6, S. 9, Abb. 7, S. 14, Abb. 11, S. 15, Abb. 12]", new long[]{0,1,2,3,4}, new []{kaiserpfalz_Slider1_1,kaiserpfalz_Slider1_2,kaiserpfalz_Slider1_3,kaiserpfalz_Slider1_4,kaiserpfalz_Slider1_5}, true, sprechertext_2_2);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_4);
UpdateProgress(151, 237);
var kaiserpfalz_Page_5 = CreateImagePage (kaiserpfalz_image_3_1, null, null, sprechertext_3_1);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_5);
UpdateProgress(152, 237);
var kaiserpfalz_Page_6 = CreateImagePage (kaiserpfalz_image_3_2, null, null, sprechertext_3_2);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_6);
UpdateProgress(153, 237);
var kaiserpfalz_Page_7 = CreateImagePage (kaiserpfalz_image_4, null, null, sprechertext_4);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_7);
UpdateProgress(154, 237);
var kaiserpfalz_Page_8 = CreateImagePage (kaiserpfalz_image_5_1, null, null, sprechertext_5_1);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_8);
UpdateProgress(155, 237);
var kaiserpfalz_Page_9 = CreateImagePage (kaiserpfalz_image_5_2, null, null, sprechertext_5_2);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_9);
UpdateProgress(156, 237);
var kaiserpfalz_Page_10 = CreateImagePage (kaiserpfalz_image_5_3, null, null, sprechertext_5_3);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_10);
UpdateProgress(157, 237);
var kaiserpfalz_Page_11 = CreateImagePage (kaiserpfalz_image_7_1, null, null, sprechertext_7_1);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_11);
UpdateProgress(158, 237);
var kaiserpfalz_Page_12 = CreateTimeSliderPage("Grundrisse", "Maßstabsgetreue Grundrisse der Pfalzanlagen in Paderborn, Aachen und Ingelheim.", new long[]{0,1,2}, new []{kaiserpfalz_slider2_1,kaiserpfalz_slider2_2,kaiserpfalz_slider2_3}, true, sprechertext_7_2);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_12);
UpdateProgress(159, 237);
var kaiserpfalz_Page_13 = CreateImagePage (kaiserpfalz_image_last, null, null, sprechertext_8);
kaiserpfalz.Pages.Add(kaiserpfalz_Page_13);
UpdateProgress(160, 237);
...
UpdateProgress(161, 237);
var karldergroßeimwandelderzeit_Page_24_1 = CreateTimeSliderPage("Rotho-Grabmal", "Mehr Informationen zum Rotho-Grabmal", new long[]{0,1,2}, new []{domRothoGrabmalDetailEngelNordseite1,domRothoGrabmalDetailEngelNordseite2,domRothoGrabmalDetailEngelSüdseite}, true, _124);
UpdateProgress(162, 237);
var karldergroßeimwandelderzeit_Page_2_2 = CreateImagePage (noImage, null, null, _023_karlsbild);
UpdateProgress(163, 237);
var karldergroßeimwandelderzeit_Page_24_2 = CreateImagePage (noImage, null, null, _139);
UpdateProgress(164, 237);
var karldergroßeimwandelderzeit_Page_24_3 = CreateImagePage (domRothograbmalGesamtansichtEinfärbungThuriferar, null, null, _147);
UpdateProgress(165, 237);
var karldergroßeimwandelderzeit_Page_24_4 = CreateImagePage (GrabmalBischofRothosvonPaderborn, null, null, _149);
UpdateProgress(166, 237);
var karldergroßeimwandelderzeit_Page_2_1 = CreateImagePage (noImage, null, null, _020_karlsbild);
UpdateProgress(167, 237);
var karldergroßeimwandelderzeit_Page_1 = CreateAppetizerPage ("Der Blick auf Karl den Großen: Christ, Frankenkönig, Imperator, Heiliger.", karldergroßeimwandel_teaser);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_1);
UpdateProgress(168, 237);
var karldergroßeimwandelderzeit_Page_2 = CreateImagePage (noImage, null, null, _016_karlsbild);
karldergroßeimwandelderzeit_Page_2.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_2_1);
karldergroßeimwandelderzeit_Page_2.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_2_2);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_2);
UpdateProgress(169, 237);
var karldergroßeimwandelderzeit_Page_3 = CreateImagePage (domRothoGrabmalDetailKdG, null, null, _032_karlsbild);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_3);
UpdateProgress(170, 237);
var karldergroßeimwandelderzeit_Page_4 = CreateTimeSliderPage("Bildzeugnisse", "Bildzeugnisse aus karolingischer Zeit", new long[]{0,1,2}, new []{berlinMünzeVorderseite,parisLouvreReiterstatue,domRothoGrabmalDetailKdG2}, true, _035_karlsbild);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_4);
UpdateProgress(171, 237);
var karldergroßeimwandelderzeit_Page_5 = CreateImagePage (noImage, null, null, _037_karlsbild);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_5);
UpdateProgress(172, 237);
var karldergroßeimwandelderzeit_Page_6 = CreateImagePage (noImage, null, null, _041);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_6);
UpdateProgress(173, 237);
var karldergroßeimwandelderzeit_Page_7 = CreateImagePage (noImage, null, null, _043);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_7);
UpdateProgress(174, 237);
var karldergroßeimwandelderzeit_Page_8 = CreateTimeSliderPage("Berlin Münze", "Vorderseite der Bildnismünze Karls des Großen, Frankfurt (?), nach 800, Silber geprägt, 1,71 g, Durchmesser: 19,9 mm, KAROLVS IMP(erator) AVG(ustus). Unter der Büste ein F (laut Philip Grierson steht dies für Frankfurt als Münzstätte, Philip Grierson: Money and Coinage under Charlemagne, in: Karl der Große. Lebenswerk und Nachleben, 5 Bde., hg. von Wolfgang Braunfels, Düsseldorf 1965-1968, Bd. 1: Persönlichkeit und Geschichte, hg. von Helmut Beumann, Düsseldorf 1965, S. 501-535), Berlin, Staatliche Museen zu Berlin, Münzkabinett, Inventar-Nr.: 18202748.© bpk / Münzkabinett, SMB / Lutz Jürgen Lübke", new long[]{0,1}, new []{berlinMünzeVorderseite2,berlinMünzeVorderSeiteHighlighted}, true, _052);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_8);
UpdateProgress(175, 237);
var karldergroßeimwandelderzeit_Page_9 = CreateImagePage (noImage, null, null, _054);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_9);
UpdateProgress(176, 237);
var karldergroßeimwandelderzeit_Page_10 = CreateImagePage (berlinMünzeVorderseite3, null, null, _059);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_10);
UpdateProgress(177, 237);
var karldergroßeimwandelderzeit_Page_11 = CreateImagePage (berlinMünzeRückseiteHighlighted, null, null, _062);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_11);
UpdateProgress(178, 237);
var karldergroßeimwandelderzeit_Page_12 = CreateImagePage (parisLouvreReiterStatuetteGesamt, null, null, _065);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_12);
UpdateProgress(179, 237);
var karldergroßeimwandelderzeit_Page_13 = CreateImagePage (noImage, null, null, _075);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_13);
UpdateProgress(180, 237);
var karldergroßeimwandelderzeit_Page_14 = CreateImagePage (noImage, null, null, _080);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_14);
UpdateProgress(181, 237);
var karldergroßeimwandelderzeit_Page_15 = CreateImagePage (noImage, null, null, _081);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_15);
UpdateProgress(182, 237);
var karldergroßeimwandelderzeit_Page_16 = CreateImagePage (noImage, null, null, _084);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_16);
UpdateProgress(183, 237);
var karldergroßeimwandelderzeit_Page_17 = CreateImagePage (noImage, null, null, _089);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_17);
UpdateProgress(184, 237);
var karldergroßeimwandelderzeit_Page_18 = CreateImagePage (domRothoGrabmalGesamtansicht, null, null, _103);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_18);
UpdateProgress(185, 237);
var karldergroßeimwandelderzeit_Page_19 = CreateImagePage (domRothoGrabmalGesamtansichtEinfärbung, null, null, _107);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_19);
UpdateProgress(186, 237);
var karldergroßeimwandelderzeit_Page_20 = CreateImagePage (domRothograbmalKarlderGroßeEinfärbungSpruchband, null, null);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_20);
UpdateProgress(187, 237);
var karldergroßeimwandelderzeit_Page_21 = CreateImagePage (reproRatsgestuehlKarlderGroßeFockeMuseumBremenInventarNr00294, null, null, _113);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_21);
UpdateProgress(188, 237);
var karldergroßeimwandelderzeit_Page_22 = CreateTimeSliderPage("Rotho-Grabmal ", "Personen auf dem Rotho-Grabmal", new long[]{0,1,2}, new []{domRothograbmalLeoEinfärbung,domRothoGrabmalDetailKdG,domRothograbmalDetailLeo}, true);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_22);
UpdateProgress(189, 237);
var karldergroßeimwandelderzeit_Page_23 = CreateImagePage (noImage, null, null, _122);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_23);
UpdateProgress(190, 237);
var karldergroßeimwandelderzeit_Page_24 = CreateImagePage (noImage, null, null, _123);
karldergroßeimwandelderzeit_Page_24.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_24_1);
karldergroßeimwandelderzeit_Page_24.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_24_2);
karldergroßeimwandelderzeit_Page_24.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_24_3);
karldergroßeimwandelderzeit_Page_24.AdditionalInformationPages.Add(karldergroßeimwandelderzeit_Page_24_4);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_24);
UpdateProgress(191, 237);
var karldergroßeimwandelderzeit_Page_25 = CreateImagePage (noImage, null, null, _159);
karldergroßeimwandelderzeit.Pages.Add(karldergroßeimwandelderzeit_Page_25);
UpdateProgress(192, 237);
...
UpdateProgress(193, 237);
var KarlsSiegUberDieSachsen_Page_1 = CreateAppetizerPage ("Sachsen wird Teil des Frankenreiches.", Teaser_KarlsSieg);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_1);
UpdateProgress(194, 237);
var KarlsSiegUberDieSachsen_Page_2 = CreateImagePage (noImage, null, null, _029);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_2);
UpdateProgress(195, 237);
var KarlsSiegUberDieSachsen_Page_3 = CreateImagePage (noImage, null, null, _030);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_3);
UpdateProgress(196, 237);
var KarlsSiegUberDieSachsen_Page_4 = CreateImagePage (noImage, null, null, _031);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_4);
UpdateProgress(197, 237);
var KarlsSiegUberDieSachsen_Page_5 = CreateImagePage (noImage, null, null, _032);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_5);
UpdateProgress(198, 237);
var KarlsSiegUberDieSachsen_Page_6 = CreateImagePage (noImage, null, null, _033);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_6);
UpdateProgress(199, 237);
var KarlsSiegUberDieSachsen_Page_7 = CreateImagePage (noImage, null, null, _034);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_7);
UpdateProgress(200, 237);
var KarlsSiegUberDieSachsen_Page_8 = CreateImagePage (noImage, null, null, _035);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_8);
UpdateProgress(201, 237);
var KarlsSiegUberDieSachsen_Page_9 = CreateImagePage (noImage, null, null, _036);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_9);
UpdateProgress(202, 237);
var KarlsSiegUberDieSachsen_Page_10 = CreateImagePage (noImage, null, null, _037);
KarlsSiegUberDieSachsen.Pages.Add(KarlsSiegUberDieSachsen_Page_10);
UpdateProgress(203, 237);
...
UpdateProgress(204, 237);
var LebenAmWasser_Page_1 = CreateAppetizerPage ("Paderborn – so schön wie das Land, in dem Milch und Honig fließen?", Teaser_LebenAmWasser);
LebenAmWasser.Pages.Add(LebenAmWasser_Page_1);
UpdateProgress(205, 237);
var LebenAmWasser_Page_2 = CreateImagePage (noImage, null, null, _007);
LebenAmWasser.Pages.Add(LebenAmWasser_Page_2);
UpdateProgress(206, 237);
...
UpdateProgress(207, 237);
var PaderbrunnonPatresbrunPaderbruno_Page_1 = CreateAppetizerPage ("Die Siedlung an den 200 Quellen. Woher kommt eigentlich der Name Paderborn", Teaser_Paderbrunnon);
PaderbrunnonPatresbrunPaderbruno.Pages.Add(PaderbrunnonPatresbrunPaderbruno_Page_1);
UpdateProgress(208, 237);
var PaderbrunnonPatresbrunPaderbruno_Page_2 = CreateImagePage (noImage, null, null, _004);
PaderbrunnonPatresbrunPaderbruno.Pages.Add(PaderbrunnonPatresbrunPaderbruno_Page_2);
UpdateProgress(209, 237);
var PaderbrunnonPatresbrunPaderbruno_Page_3 = CreateImagePage (noImage, null, null, _005);
PaderbrunnonPatresbrunPaderbruno.Pages.Add(PaderbrunnonPatresbrunPaderbruno_Page_3);
UpdateProgress(210, 237);
var PaderbrunnonPatresbrunPaderbruno_Page_4 = CreateImagePage (noImage, null, null, _006);
PaderbrunnonPatresbrunPaderbruno.Pages.Add(PaderbrunnonPatresbrunPaderbruno_Page_4);
UpdateProgress(211, 237);
...
UpdateProgress(212, 237);
var Sachsenkriege_Page_1 = CreateAppetizerPage ("Karl der Große und die Sachsen – dreißig Jahre Krieg!", Teaser_Sachenkriege);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_1);
UpdateProgress(213, 237);
var Sachsenkriege_Page_2 = CreateImagePage (noImage, null, null, _019);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_2);
UpdateProgress(214, 237);
var Sachsenkriege_Page_3 = CreateImagePage (Stuttgart_WLB_Cod, null, null, _020);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_3);
UpdateProgress(215, 237);
var Sachsenkriege_Page_4 = CreateImagePage (noImage, null, null, _021);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_4);
UpdateProgress(216, 237);
var Sachsenkriege_Page_5 = CreateImagePage (noImage, null, null, _022);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_5);
UpdateProgress(217, 237);
var Sachsenkriege_Page_6 = CreateImagePage (noImage, null, null, _023);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_6);
UpdateProgress(218, 237);
var Sachsenkriege_Page_7 = CreateImagePage (KarteDesAltsachsischenSprachraums, null, null, _024);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_7);
UpdateProgress(219, 237);
var Sachsenkriege_Page_8 = CreateImagePage (KarteDesAltsachsischenSprachraums, null, null, _025);
Sachsenkriege.Pages.Add(Sachsenkriege_Page_8);
UpdateProgress(220, 237);
...
UpdateProgress(221, 237);
var taufenanderpader_Page_5_1 = CreateImagePage (KarteDesAltsachsischenSprachraums, null, null, _013);
UpdateProgress(222, 237);
var taufenanderpader_Page_5_2 = CreateImagePage (KarteDesAltsachsischenSprachraums, null, null, _014);
UpdateProgress(223, 237);
var taufenanderpader_Page_4_1 = CreateTextPage("Sagst du dem Teufel ab?\n	Und er antwortet: Ich sage dem Teufel ab.\nUnd allem Teufelsopfer?\n	Er antwortet: Und ich sage ab allem Teufelsopfer.\nUnd allen Werken des Teufels?\n	Er antwortet: Und ich schwöre ab allen Werken und Worten \n	des Teufels, Donar und Wotan und Saxnot und all den \n	Teufeln, die ihre Genossen sind.\nGlaubst du an Gott, den allmächtigen Vater?\n	Ich glaube an Gott, den allmächtigen Vater.\nGlaubst du an Christus, den Sohn Gottes?\n	Ich glaube an Christus, den Sohn Gottes.\nGlaubst du an den Heiligen Geist?\n	Ich glaube an den Heiligen Geist.", "Hochdeutschen Übersetzung des Altsächsischen Taufgelöbnisses", "Übersetzung zitiert nach: Walter Haug / Benedikt Konrad Vollmann (Hg.): Frühe deutsche Literatur und lateinische Literatur in Deutschland 800-1150 (Bibliothek des Mittelalters 1) (Bibliothek deutscher Klassiker 62), Frankfurt a.M. 1991, S. 19.", null, _011);
UpdateProgress(224, 237);
var taufenanderpader_Page_1 = CreateAppetizerPage ("Donar, Wotan und Saxnot – die Abkehr von den alten Göttern.", Teaser_TaufenAnDerPader);
taufenanderpader.Pages.Add(taufenanderpader_Page_1);
UpdateProgress(225, 237);
var taufenanderpader_Page_2 = CreateImagePage (noImage, null, null, _008);
taufenanderpader.Pages.Add(taufenanderpader_Page_2);
UpdateProgress(226, 237);
var taufenanderpader_Page_3 = CreateImagePage (MünchenBSBClm22053_16r, null, null, _009);
taufenanderpader.Pages.Add(taufenanderpader_Page_3);
UpdateProgress(227, 237);
var taufenanderpader_Page_4 = CreateTextPage("Sagst du dem Teufel ab?\n	Und er antwortet: Ich sage dem Teufel ab.\nUnd allem Teufelsopfer?\n	Er antwortet: Und ich sage ab allem Teufelsopfer.\nUnd allen Werken des Teufels?\n	Er antwortet: Und ich schwöre ab allen Werken und Worten \n	des Teufels, Donar und Wotan und Saxnot und all den \n	Teufeln, die ihre Genossen sind.\nGlaubst du an Gott, den allmächtigen Vater?\n	Ich glaube an Gott, den allmächtigen Vater.\nGlaubst du an Christus, den Sohn Gottes?\n	Ich glaube an Christus, den Sohn Gottes.\nGlaubst du an den Heiligen Geist?\n	Ich glaube an den Heiligen Geist.", "Hochdeutschen Übersetzung des Altsächsischen Taufgelöbnisses", "Übersetzung zitiert nach: Walter Haug / Benedikt Konrad Vollmann (Hg.): Frühe deutsche Literatur und lateinische Literatur in Deutschland 800-1150 (Bibliothek des Mittelalters 1) (Bibliothek deutscher Klassiker 62), Frankfurt a.M. 1991, S. 19.", null, _010);
taufenanderpader_Page_4.AdditionalInformationPages.Add(taufenanderpader_Page_4_1);
taufenanderpader.Pages.Add(taufenanderpader_Page_4);
UpdateProgress(228, 237);
var taufenanderpader_Page_5 = CreateTextPage("Priester: Widersagt ihr dem Satan?\n	Antwort: Ich widersage.\nPriester: Und all seiner Bosheit?\n	Antwort: Ich widersage.\nPriester: Und all seinen Verlockungen?\n	Antwort: Ich widersage.\nPriester: Glaubt ihr an Gott, den Vater, den Allmächtigen, den Schöpfer des Himmels und der Erde?\n	Antwort: Ich glaube.\nPriester: Glaubt ihr an Jesus Christus, seinen eingeborenen Sohn, unseren Herrn, der geboren ist \nvon der Jungfrau Maria, der gelitten hat und begraben wurde, von den Toten auferstand und zur Rechten des Vaters sitzt?\n	Antwort: Ich glaube.\nPriester: Glaubt ihr an den Heiligen Geist, die heilige katholische Kirche, die Gemeinschaft der Heiligen, die Vergebung der Sünden, die Auferstehung der Toten und das ewige Leben?\n	Antwort: Ich glaube.", "Hochdeutschen Übersetzung des Altsächsischen Taufgelöbnisses", "zitiert nach: Anselm Schott / Erzabtei St. Martin zu Beuron: Volks-Schott. Für das Lesejahr B. Originaltexte der deutschsprachigen Altarausgabe des Meßbuchs und des Lektionars, Freiburg i.B. 1975, S. 198-199.\n\n(Unter Mitarbeit von Thorsten Schlömer, Student der Germanistik)", null, _012);
taufenanderpader_Page_5.AdditionalInformationPages.Add(taufenanderpader_Page_5_1);
taufenanderpader_Page_5.AdditionalInformationPages.Add(taufenanderpader_Page_5_2);
taufenanderpader.Pages.Add(taufenanderpader_Page_5);
UpdateProgress(229, 237);
var taufenanderpader_Page_6 = CreateImagePage (noImage, null, null, _015);
taufenanderpader.Pages.Add(taufenanderpader_Page_6);
UpdateProgress(230, 237);
var taufenanderpader_Page_7 = CreateImagePage (noImage, null, null, _016);
taufenanderpader.Pages.Add(taufenanderpader_Page_7);
UpdateProgress(231, 237);
var taufenanderpader_Page_8 = CreateTimeSliderPage("Berlin Taufschale Widukinds", "Die sogenannte Taufschale Widukinds, Montierung 12. Jh., Steinschliff wohl spätantik, grüner Serpentin, geschnitten und geschliffen; Montierung Bronze, gegossen, teilweise getrieben, vergoldet, Inschrift nielliert, Deckblech der Daumenplatte Silber, ehemals nielliert, Maße: 3,5 x 13, 15 x 17,5 cm, aus dem Schatz des Stiftes St. Dionysius zu Enger/Herford, Berlin, Staatliche Museen zu Berlin – Preußischer Kulturbesitz, Kunstgewerbemuseum, Inv. Nr. K 3672. © bpk / Kunstgewerbemuseum, SMB.", new long[]{0,1}, new []{Berlin_TaufschaleWidukinds,Berlin_TaufschaleWidukinds_Einfarbung_Inschrift}, true, _017);
taufenanderpader.Pages.Add(taufenanderpader_Page_8);
UpdateProgress(232, 237);
var taufenanderpader_Page_9 = CreateImagePage (noImage, null, null, _018);
taufenanderpader.Pages.Add(taufenanderpader_Page_9);
UpdateProgress(233, 237);
var bar = CreateRouteTag("Bar", "bar", CreateImage("","","route_tag_bar.png"));
UpdateProgress(234, 237);
var restaurant = CreateRouteTag("Restaurant", "restaurant", CreateImage("","","route_tag_restaurant.png"));
UpdateProgress(235, 237);

...
namespace de.upb.hip.mobile.droid.Helpers {
    public class DbDummyDataFiller {
        ...
        public void InsertData ()
        {
            ...
            img.Description = "Fooooo";
            dom.Pages.Add(page);
            page = BusinessEntitiyFactory.CreateBusinessObject<Page> ();
            var textpage = BusinessEntitiyFactory.CreateBusinessObject<TextPage> ();
            page.TextPage = textpage;
            textpage.Text = "Hallo Welt";
            dom.Pages.Add (page);
            page = BusinessEntitiyFactory.CreateBusinessObject<Page> ();
            var imgPage = BusinessEntitiyFactory.CreateBusinessObject<ImagePage> ();
            page.ImagePage = imgPage;
            imgPage.Image = img;
            dom.Pages.Add (page);
            var timeSliderPage = BusinessEntitiyFactory.CreateBusinessObject<TimeSliderPage> ();
            page.TimeSliderPage = timeSliderPage;
            timeSliderPage.Text = "Foo";
            var date = BusinessEntitiyFactory.CreateBusinessObject<LongElement> ();
            date.Value = 1234;
            timeSliderPage.Dates.Add (date);
            timeSliderPage.Title = "Bar";
            timeSliderPage.Images.Add (img);
            //dom.Pages.Add (page);
